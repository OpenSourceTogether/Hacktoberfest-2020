...
5. Commit your changes `git commit -m  "added myself"`
6. Push to your fork `git push origin new-user` and [submit a pull request](https://github.com/chandan-reddy-k/Hacktoberfest-2020/compare).
