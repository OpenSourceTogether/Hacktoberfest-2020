...
const Home = ({ contributors }) => ( <
    ...
    Head / >
    <
    Grid className = { styles.welcomeGridWrapper }
    container >
    <
    Typography variant = { "h1" }
    className = { styles.welcomeText } > Let 's change the world together with Open source!</Typography> <
    ...
    href = "https://github.com/domitech/Hacktoberfest-2020"
    ...
    contributors && contributors.map((item, index) => {
            return ( <
                ...
                key = { index }
                as = { `/contributors/${item["github-username"]}` } >
                <
                Chip style = {
                    {
